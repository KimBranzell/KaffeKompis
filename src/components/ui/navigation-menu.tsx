...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Item
    ref={ref}
    className={cn("py-2 px-4group inline-flex h-10 w-max items-center justify-center text-text rounded-md bg-main px-4 py-2 font-bold transition-colors disabled:pointer-events-none disabled:opacity-50 group m750:max-w-[80px]", className)}
    {...props}
  />
))
...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center justify-center text-text rounded-md bg-main font-bold transition-colors disabled:pointer-events-none disabled:opacity-50"
)
